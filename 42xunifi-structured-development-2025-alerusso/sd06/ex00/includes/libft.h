...
/*   Updated: 2025/06/18 18:42:26 by alerusso         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		ft_lstadd_front(t_typelist **lst, t_typelist *new_list);
int			ft_lstsize(t_typelist *lst);
t_typelist	*ft_lstlast(t_typelist *lst);
void		ft_lstadd_back(t_typelist **lst, t_typelist *new_list);
