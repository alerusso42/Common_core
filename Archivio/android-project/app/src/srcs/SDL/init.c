...
/*   Updated: 2025/10/02 01:49:28 by alerusso         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../includes/pacman.h"
# include "jni/SDL_mixer/include/SDL_mixer.h"
# include "jni/SDL_image/include/SDL_image.h"
...
int		init_render(t_data *data)
{
	...
	SDL_GetWindowSize(data->sdl.win, &data->sdl.screen[X], &data->sdl.screen[Y]);
	return (0);
}
