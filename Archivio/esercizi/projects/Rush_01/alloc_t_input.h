...
/*   Updated: 2024/11/05 18:33:12 by alerusso         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	alloc_user_input(t_input **input, t_onebyte game_size)
{
	...
	if ((*input) == NULL)
		return (2);
	size_memory = (sizeof(int)) * ((game_size) + 2);
	(*input)->colup.x = (t_onebyte *)malloc(size_memory);
	(*input)->coldown.x = (t_onebyte *)malloc(size_memory);
	(*input)->rowright.y = (t_onebyte *)malloc(size_memory);
	(*input)->rowleft.y = (t_onebyte *)malloc(size_memory);
