...
/*   Updated: 2025/02/21 12:17:59 by alerusso         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
	input1->en_speed:	enemy speed.
	
	The other are straightforward, except wall_proportion.


	YOU CAN CHOOSE THE EXACT NUMBER OF WALLS, with wall_num.

	If set to zero, a proportion is calculated:

	map->void_spaces / random->wden
